...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    name: 'Periodic Table',
    emoji: '🧪',
    description: 'All 118, hydrogen to oganesson',
    items: [
  ...
  },
  {
    ...
    name: 'Shapes',
    emoji: '🔷',
    description: 'Geometry roulette',
    items: [
      'Circle', 'Triangle', 'Square', 'Rectangle', 'Pentagon', 'Hexagon',
      'Heptagon', 'Octagon', 'Nonagon', 'Decagon', 'Rhombus', 'Trapezoid',
      'Parallelogram', 'Ellipse', 'Star', 'Crescent', 'Heart', 'Arrow',
      'Sphere', 'Cube', 'Cylinder', 'Cone', 'Pyramid', 'Torus', 'Tetrahedron',
      'Dodecahedron', 'Icosahedron', 'Möbius strip',
    ],
  },
  {
    id: 'animals',
    name: 'Animal Kingdom',
    emoji: '🦊',
    description: 'Spirit animal generator',
    items: [
      'Octopus', 'Red fox', 'Snow leopard', 'Axolotl', 'Peregrine falcon',
      'Mantis shrimp', 'Capybara', 'Honey badger', 'Narwhal', 'Pangolin',
      'Tardigrade', 'Raven', 'Orca', 'Wolverine', 'Sea otter', 'Cassowary',
      'Fennec fox', 'Komodo dragon', 'Humpback whale', 'Platypus', 'Lynx',
      'Giant squid', 'Harpy eagle', 'Red panda', 'Wombat', 'Elephant',
      'Chameleon', 'Snowy owl', 'Manta ray', 'Hedgehog', 'Moose', 'Quokka',
      'Bison', 'Pufferfish', 'Gibbon', 'Secretary bird', 'Leafcutter ant',
      'Blue whale', 'Sand cat', 'Emperor penguin',
    ],
  },
  {
    id: 'travel',
